...
latex_documents = [
    (master_doc, "aat.tex", "aat Documentation", "Tim Paine", "manual"),
]
...
man_pages = [(master_doc, "aat", "aat Documentation", [author], 1)]
...
def run_apidoc(_):
    ...
    subprocess.check_call([cmd_path, "-E", "-M", "-o", out_dir, aat_dir, "--force"])

...
namespace core {
    ...
    std::vector<std::vector<float>> OrderBook::topOfBook() const {}
    double OrderBook::spread() const {}
    std::vector<std::vector<float>> OrderBook::level(std::uint64_t level, Side side) const {}
    std::vector<std::vector<float>> OrderBook::level(double price) const {}
    std::vector<std::vector<float>> OrderBook::levels(std::uint64_t levels) const {}
